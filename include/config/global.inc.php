...
$config['db']['user'] = 'root';
$config['db']['pass'] = 'hanxianzhai@gmail.com';
$config['db']['port'] = 3306;
$config['db']['name'] = 'mpos3';
...
$config['wallet']['host'] = 'localhost:11000';
$config['wallet']['username'] = 'test';
$config['wallet']['password'] = 'test1';
 ...
 *   threshold  :  25
 **/
$config['coldwallet']['address'] = 'LfEpFYomWfrnLidXJJoVSAUWYAG7GiqFPL';
$config['coldwallet']['reserve'] = 50;
$config['coldwallet']['threshold'] = 25;
 ...
 *   pin    =  3
 **/
$config['maxfailed']['login'] = 8;
$config['maxfailed']['pin'] = 8;
...
$config['ap_threshold']['max'] = 100000000;
